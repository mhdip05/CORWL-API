...
namespace NMS_API_N.Migrations
{
    ...
    [Migration("20230418203333_employeeDocuments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NMS_API_N.Model.Entities.EmployeeDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EmployeeDocumentInfoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EmployeeDocumentInfoId");

                    b.ToTable("EmployeeDocuments");
                });

            modelBuilder.Entity("NMS_API_N.Model.Entities.EmployeeDocumentInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EmployeeDocumentInfos");
                });
            ...
            modelBuilder.Entity("NMS_API_N.Model.Entities.EmployeeDocument", b =>
                {
                    b.HasOne("NMS_API_N.Model.Entities.EmployeeDocumentInfo", "EmployeeDocumentInfo")
                        .WithMany()
                        .HasForeignKey("EmployeeDocumentInfoId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("EmployeeDocumentInfo");
                });
